...
# We can choose different env settings by looking up https://github.com/openai/gym/wiki/Table-of-environments
env_id = "PongNoFrameskip-v5"
...
for frame_idx in range(1, num_frames + 1):
    ...
    # state (1, 84, 84), action (0-5), reward 0.0, next_state (1, 84, 84), done (T,F)
...
with open("all_rewards_file.pkl", "w") as all_rewards_file:
